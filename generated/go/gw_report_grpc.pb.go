...
const (
	...
	ReportsService_FlagReport_FullMethodName   = "/reports_svc.ReportsService/FlagReport"
)
...
type ReportsServiceClient interface {
	...
	FlagReport(ctx context.Context, in *FlagReportRequest, opts ...grpc.CallOption) (*FlagReportResponse, error)
}
...
func (c *reportsServiceClient) FlagReport(ctx context.Context, in *FlagReportRequest, opts ...grpc.CallOption) (*FlagReportResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(FlagReportResponse)
	err := c.cc.Invoke(ctx, ReportsService_FlagReport_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ReportsServiceServer interface {
	...
	FlagReport(context.Context, *FlagReportRequest) (*FlagReportResponse, error)
...
func (UnimplementedReportsServiceServer) FlagReport(context.Context, *FlagReportRequest) (*FlagReportResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method FlagReport not implemented")
}
...
func _ReportsService_FlagReport_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(FlagReportRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ReportsServiceServer).FlagReport(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ReportsService_FlagReport_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ReportsServiceServer).FlagReport(ctx, req.(*FlagReportRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ReportsService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "FlagReport",
			Handler:    _ReportsService_FlagReport_Handler,
		},
	},
