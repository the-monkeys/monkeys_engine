...
// EmailChangeOTPEmailHTML returns an HTML email body containing a 6-digit OTP for email change verification.
// This email is sent to the NEW email address to verify ownership.
func EmailChangeOTPEmailHTML(firstName, lastName, otpCode string) string {
	return `<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <title>Verify New Email - The Monkeys</title>
</head>
<body style="margin:0; padding:0; background-color:#ffffff; font-family:Arial, Helvetica, sans-serif;">
    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="background-color:#ffffff;">
        <tr>
            <td align="center" style="padding:40px 20px;">
                <table role="presentation" width="480" cellpadding="0" cellspacing="0" border="0" style="max-width:480px; width:100%;">
                    <tr>
                        <td style="padding-bottom:32px;">
                            <h2 style="margin:0; font-size:22px; font-weight:700; color:#18181b;">Verify your new email</h2>
                        </td>
                    </tr>
                    <tr>
                        <td style="padding-bottom:24px;">
