...
const file_apis_serviceconn_gateway_authz_pb_gw_auth_proto_rawDesc = "" +
	...
	"\rrefresh_token\x18\f \x01(\tR\frefreshToken\"O\n" +
	"\x05Error\x12\x16\n" +
	...
	"\x05error\x18\n" +
	" \x01(\v2\x0f.auth_svc.ErrorR\x05error\x12#\n" +
	"\rrefresh_token\x18\v \x01(\tR\frefreshToken\x12\x1d\n" +
	"\n" +
	"account_id\x18\f \x01(\tR\taccountId\"\x98\x01\n" +
	...
	" \x01(\v2\x0f.auth_svc.ErrorR\x05error\x12\x1d\n" +
	"\n" +
	"account_id\x18\v \x01(\tR\taccountId\"6\n" +
	"\x0fRefreshTokenReq\x12#\n" +
	"\rrefresh_token\x18\x01 \x01(\tR\frefreshToken\"\x94\x01\n" +
	"\x0fRefreshTokenRes\x12\x1f\n" +
	"\vstatus_code\x18\x01 \x01(\x03R\n" +
	"statusCode\x12\x14\n" +
	"\x05token\x18\x02 \x01(\tR\x05token\x12#\n" +
	"\rrefresh_token\x18\x03 \x01(\tR\frefreshToken\x12%\n" +
	"\x05error\x18\x04 \x01(\v2\x0f.auth_svc.ErrorR\x05error*\x88\x01\n" +
	"\bPlatform\x12\x18\n" +
	...
	"\x10PLATFORM_DESKTOP\x10\x052\xbb\t\n" +
	"\vAuthService\x12O\n" +
	...
	"\x0fDecodeSignedJWT\x12 .auth_svc.DecodeSignedJWTRequest\x1a!.auth_svc.DecodeSignedJWTResponse\"\x00\x12F\n" +
	"\fRefreshToken\x12\x19.auth_svc.RefreshTokenReq\x1a\x19.auth_svc.RefreshTokenRes\"\x00B%Z#./apis/serviceconn/gateway_authz/pbb\x06proto3"
